...
\item learn the main R data structures – vector and data frame
\item compute basic summary statistics
\item produce data visualisations with the ggplot package
