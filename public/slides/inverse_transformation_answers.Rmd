...
# STA 326 2.0 Programming and Data Analysis with

# Generating Random Numbers Using Inverse Transform Method
...
\begin{table}[!h]
\begin{tabular}{ll|ll}
\textbf{rbeta} & beta distribution & \textbf{lnorm} & log-normal distribution \\
\textbf{rbinom} & binomial distribution & \textbf{multinom} & multinomial distribution  \\
\textbf{rcauchy} & Cauchy distribution & \textbf{nbinom} & negative binomial distribution \\
...
\textbf{rgeom} & geometric distribution &  \textbf{weibull} & Weibull distribution\\
