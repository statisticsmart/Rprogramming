...
11. Create a vector with elements from 1 to 100 incrementing by 0.4. Your output should look like the sample output given below.
...
```
    ...
    (b) Convert all values of `age` that are NOT from 10 to 100 and calculate the mean of valid responses.
