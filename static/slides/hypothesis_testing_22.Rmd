...
$H_0: \mu_M \leq \mu_F$  vs $H_1: \mu_M > \mu_F$

$\mu_M$ - Population mean weight of male penguins

$\mu_F$ - Population mean weight of female penguins
...
data(penguins)
inference(x=sex, y=flipper_length_mm ,data=penguins, alternative  = "greater", order = c("male", "female"), 
          statistic="mean", 
          type="ht",
          method="theoretical")
...
ggplot(penguins, aes(x=flipper_length_mm, y=species)) + geom_boxplot() +  stat_summary(fun.x=mean, colour="darkred", geom="point", size=5)
```
...
ggplot(penguins, aes(x=flipper_length_mm, y=species)) + geom_boxplot(notch = TRUE)
...
inference(x=species, y=flipper_length_mm ,data=penguins,
          statistic="mean", 
          type="ht",
          method="theoretical")
```
