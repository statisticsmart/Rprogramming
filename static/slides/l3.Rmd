...
1. A particular mobile phone number is used to receive both voice messages and text messages. Suppose 20% of the messages involve text messages, and consider a sample of 15 messages. Waht is the probability that 

    - At most 8 of the messages involve a text message?
    
    - Exactly 8 of the messages involve a text message.
    
1. Generate 5 random values from a Poisson distribution with mean 10.
