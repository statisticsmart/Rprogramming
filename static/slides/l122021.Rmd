...
subtitle: "✍️ The Grammar of Graphics"  
author: 
  - ""
...
<img src="ggplotaes/scales.PNG" alt="knitrhex" height="400"/>
...
.right-plot[
```{r, comment=NA,  echo=FALSE, fig.height=4, warning=FALSE, message=FALSE}
ggplot(iris)
```
]
...
.pull-left[
<img src="ggplotaes/aes.PNG" alt="knitrhex" height="400"/>
]
...
.pull-left[
<img src="ggplotaes/geom.PNG" alt="knitrhex" height="400"/>
]
...
.pull-left[
```{r, comment=NA, fig.height=4, warning=FALSE, message=FALSE}
ggplot(iris,
aes(x = Sepal.Length, 
    y = Sepal.Width))+
  geom_point()
...
.pull-right[
<img src="ggplotaes/d1.PNG" alt="knitrhex" width="400"/>
...
<img src="ggplotaes/d2.PNG" alt="knitrhex" width="400"/>

]
---
# Facets: small multiples

<img src="ggplotaes/facets.PNG" alt="knitrhex" height="400"/>
...
<img src="ggplotaes/stat.PNG" alt="knitrhex" height="400"/>
...
<img src="ggplotaes/coord.PNG" alt="knitrhex" height="400"/>
...
```{r, comment=NA,  echo=FALSE,  warning=FALSE, message=FALSE, fig.height=4}
ggplot(iris,
aes(x=Sepal.Length, 
    y= Sepal.Width,
    col=Species))+
...
<img src="ggplotaes/theme.PNG" alt="knitrhex" height="400"/>
...
.right-plot[
```{r, comment=NA,  echo=FALSE, out.width="70%", warning=FALSE, message=FALSE}
ggplot(iris,
aes(x=Sepal.Length, 
    y= Sepal.Width,
    col=Species))+
...
.right-plot[
```{r, comment=NA,  echo=FALSE, fig.height=6, warning=FALSE, message=FALSE, fig.height=4}
gapminder2007 <- gapminder %>%
  filter(year==2007)
ggplot(gapminder2007,
